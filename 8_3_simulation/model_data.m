...
top_noise = 2e-2; % force excitation
bot_noise = 1e-12;   % kinematic excitation
ts_noise = 1.6e-5; % white noise sampling time
tp = 1; % (%) pulse width ratio
Fp = 296/2; % N ... peak-to-peak of white noise
RMSforce = 35;
