...
% Position
disps_d = out_ctc.displacement_d.Data(out_ctc.displacement_d.Time>0.5,:);
eulangles_d = quat2eul(out_ctc.quat_d.Data(out_ctc.quat_d.Time>0.5,:),'ZYX'); % ZXZ...yaw->pitch->roll
disps = out_ctc.displacement.Data(out_ctc.displacement.Time>0.5,:);
eulangles = quat2eul(out_ctc.quat.Data(out_ctc.quat.Time>0.5,:),'ZYX'); % ZXZ...yaw->pitch->roll
time_smooth = out_ctc.displacement_d.Time;
